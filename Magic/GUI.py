...
def SecurityUI():
    ...
    t1 = Label(
        win, text="Username:", bg=bg_colour, fg=text_color, font="Nebula 10 bold"
    ).place(x=20, y=10)
    t2 = Label(
        win, text="Password:", bg=bg_colour, fg=text_color, font="Nebula 10 bold"
    ).place(x=20, y=30)
    ...
    setins = Button(
        win, text="Add User", bd=0, bg=bg_colour, fg=text_color, command=user_page
    )
    close_button = Button(
        win, text="x", font="bold", bd=0, bg=bg_colour, fg=text_color, command=exit
    )
    ...
    ver = Button(
        win, text="Verify", bd=0, command=password, bg=bg_colour, fg=text_color
    )
    ver.place(x=70, y=60)
