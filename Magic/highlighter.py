...
keywords = [
    "search", "browse", "srch", "msg", "whatsapp", "bye", "tata", "close",
    "exit", "file", "f", "run", "theme", "firefox", "settings", "setting",
    "time", "ver", "what", "hello", "hlo", "hey", "hi", "download", "desktop",
    "music", "sh", "show", "clear", "joke", "shutdown", "restart", "open", "w",
    "website"
]
